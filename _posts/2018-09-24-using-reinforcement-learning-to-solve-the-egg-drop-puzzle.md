...
thumbnail: /assets/thumbnails/feat.png
image: /assets/thumbnails/feat.png
...
If in a terminal state (s=0 or s=1), return the ending state and total reward
if not, performAction(S,A), get R,S'
get next action A'
update E and Q
set S,A to be S',A', moving the "current state" forward
