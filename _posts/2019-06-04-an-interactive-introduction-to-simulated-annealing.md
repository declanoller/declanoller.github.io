...
thumbnail: /assets/thumbnails/sim_anneal_cover_small.png
image: /assets/thumbnails/sim_anneal_cover_small.png
...
[Here's]({{site.baseurl}}/assets/html/sims_and_interactive/SA_brach.html) an interactive example of it. Try dragging the points around to make a bad initial solution, and then hit Run to try and solve it!

<iframe 
    src="{{site.baseurl}}/assets/html/sims_and_interactive/SA_brach.html"
...
This illustrates the mechanism, but this example is too small to see the really cool stuff, because it's almost entirely boundary. [Let's try with a bigger one!]({{site.baseurl}}/assets/html/sims_and_interactive/SA_ising_squares.html)
